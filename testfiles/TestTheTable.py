...
t.tableInsert("hermans", zaaltje, eval(lst[j]))
t.tableInsert("hermans", zaaltje_yoopie, eval(lst[j]))
t.tableInsert("hermans", zaaltje_nohappy, eval(lst[j]))
t.tableInsert("pieter", zaaltje_yay, eval(lst[j]))
print(t.tableRetrieve(0)[0])
print(t.tableRetrieve(2)[0])
print(t.tableRetrieve(8)[0].get_id())
print(t.tableRetrieve(4)[0].get_id())
print(t.tableRetrieve(1))
